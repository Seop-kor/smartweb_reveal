    ...
    <section id="clients" class="section">
      <div class="center">
        ...
        <div class="client-carousel owl-carousel">
          <img src="./img/clients/client-1.png" alt="client" class="item">
          <img src="./img/clients/client-2.png" alt="client" class="item">
          <img src="./img/clients/client-3.png" alt="client" class="item">
          <img src="./img/clients/client-4.png" alt="client" class="item">
          <img src="./img/clients/client-5.png" alt="client" class="item">
          <img src="./img/clients/client-6.png" alt="client" class="item">
          <img src="./img/clients/client-7.png" alt="client" class="item">
          <img src="./img/clients/client-8.png" alt="client" class="item">
        </div>
      </div>
    </section>
      ...
      <div class="center">
        ...
        <div class="portfolio-boxs">
          <div class="filter-menu">
            <ul>
              <li class="btns active" data-filter="*">All</li>
              <li class="btns" data-filter=".app">App</li>
              <li class="btns" data-filter=".card">Card</li>
              <li class="btns" data-filter=".web">Web</li>
            </ul>
          </div>
